...
>(({ className, asChild, caret, children, ...props }, ref) => (
  <DropdownMenuPrimitive.Trigger
    ref={ref}
    className={cn(
      'cursor-pointer select-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50',
      lineHeightClass,
      className,
    )}
    {...props}
  ...
  >
    ...
    {caret ? (
      <button className='group flex items-center gap-1'>
        {children}
        <Caret className='text-primary text-base transition-transform group-data-[state=open]:rotate-90' />
      </button>
    ) : (
      children
    )}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'bg-popover text-popover-foreground z-50 min-w-[8em] overflow-hidden rounded-md border p-1 shadow-lg',
  ...
  (
    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn(
          'bg-popover text-popover-foreground z-50 min-w-[8em] overflow-hidden rounded-md border p-1 shadow-md',
          'data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
          'data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95',
          'data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
          className,
